...
Secondly, we will be moving to a new mailing list, again hosted by CNCF. The new mailing list will be [cncf-strimzi-dev@lists.cncf.io](mailto://cncf-strimzi-dev@lists.cncf.io). 
