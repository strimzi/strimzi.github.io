...
If you want to know how to do the same using the new Kafka Mirror Maker 2 or, evev better, how to set up an "active-active" mirroring architecture, you can read more on this [blog post](https://strimzi.io/blog/2020/06/09/mirror-maker-2-eventhub/).
