...
Consider a Strimzi Kafka cluster with a Kafka client you have developed. The Strimzi Kafka cluster has been configured with a TLS listener and as such requires that clients authenticate themselves using TLS.
